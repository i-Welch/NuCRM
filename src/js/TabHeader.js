  ...
  return (
    <div className="TabHeader">
      <Tab
        ...
        content="Dashboard"
        icon={
          <Dashboard color={props.activeTab === 1 ? "#57C185" : "#576574"} />
        }
      />
      <Tab
        ...
        content="Inventory"
        icon={
          <Inventory color={props.activeTab === 2 ? "#57C185" : "#576574"} />
        }
      />
      <Tab
      ...
      <Tab
        ...
        content="Customers"
        icon={
          <Customers color={props.activeTab === 4 ? "#57C185" : "#576574"} />
        }
      />
      <Tab
        ...
        content="Analytics"
        icon={
          <Analytics color={props.activeTab === 5 ? "#57C185" : "#576574"} />
        }
      />
    </div>
  );
